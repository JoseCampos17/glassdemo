  ...
  es: {
    ...
    contact: {
      ...
      form: {
        ...
        projectTypeOptions: {
          ventanas: "Instalación de Ventanas",
          puertas: "Instalación de Puertas",
          termpaneles: "Cambio de Termopaneles",
          otro: "Otro",
        },
        width: "Ancho (cm)",
        ...
        message: "Mensaje",
        messagePlaceholder: "Describe brevemente tu proyecto, la cantidad de ventanas/puertas, etc.",
        success: "Tu solicitud de cotización ha sido enviada correctamente. Nos pondremos en contacto contigo a la brevedad.",
  ...
  en: {
    ...
    contact: {
      ...
      form: {
        ...
        projectTypeOptions: {
          ventanas: "Windows Installation",
          puertas: "Doors Installation",
          termpaneles: "Double Glazing Replacement",
          otro: "Other",
        },
        width: "Width (cm)",
        ...
        message: "Message",
        messagePlaceholder: "Briefly describe your project, number of windows/doors, etc.",
